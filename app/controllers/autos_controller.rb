class AutosController < ApplicationController
  ...
  private
    ...
    def auto_params
      params.require(:auto).permit(:modelo, :marca, :patente, :color, :img_url, :nro_puertas, :nro_asientos, :estado, :encendido, :velocidad, :cant_combustible, :posicion_id, :user_id)
    end
end
