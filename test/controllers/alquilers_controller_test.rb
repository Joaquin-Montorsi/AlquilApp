...
class AlquilersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create alquiler" do
    assert_difference("Alquiler.count") do
      post alquilers_url, params: { alquiler: { auto_id: @alquiler.auto_id, precio: @alquiler.precio, user_id: @alquiler.user_id, vencimiento: @alquiler.vencimiento } }
    end
  ...
  test "should update alquiler" do
    patch alquiler_url(@alquiler), params: { alquiler: { auto_id: @alquiler.auto_id, precio: @alquiler.precio, user_id: @alquiler.user_id, vencimiento: @alquiler.vencimiento } }
