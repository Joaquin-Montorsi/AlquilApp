...
class ReportesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reporte" do
    assert_difference("Reporte.count") do
      post reportes_url, params: { reporte: { auto_id: @reporte.auto_id, descripcion: @reporte.descripcion, user_id: @reporte.user_id } }
    end
  ...
  test "should update reporte" do
    patch reporte_url(@reporte), params: { reporte: { auto_id: @reporte.auto_id, descripcion: @reporte.descripcion, user_id: @reporte.user_id } }
