...
class TarjetaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tarjetum" do
    assert_difference("Tarjetum.count") do
      post tarjeta_url, params: { tarjetum: { fecha_caducidad: @tarjetum.fecha_caducidad, nro_tarjeta: @tarjetum.nro_tarjeta, user_id: @tarjetum.user_id } }
    end
  ...
  test "should update tarjetum" do
    patch tarjetum_url(@tarjetum), params: { tarjetum: { fecha_caducidad: @tarjetum.fecha_caducidad, nro_tarjeta: @tarjetum.nro_tarjeta, user_id: @tarjetum.user_id } }
